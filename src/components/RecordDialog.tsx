        ...
        {formFields.map(field => {
          ...
          return (
            <FlexBox
              ...
              style={{ gap: '0.35rem' }}
            >
              {feType !== 'boolean' && !isDomainField(field) && !isFkSelectField(field) && <FieldLabel field={field} />}
              {(isDomainField(field) || isFkSelectField(field)) && <FieldLabel field={field} />}
              {renderField(field)}
              {errorMsg && (
